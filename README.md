...
- 今日计划：填写今天可运动时间、睡眠、疲劳、饥饿和身体状态后生成热量、蛋白、爬坡、午饭外食、晚饭自煮。
- 打卡记录：体重、训练完成度、坡度、速度、体感、睡眠、疲劳、饥饿感。
- 自动调整：第二天计划会参考前一天完成度、RPE、睡眠和疲劳。
- DeepSeek 生成：默认调用 DeepSeek 根据当天状态生成计划，本地规则负责安全边界和忌口硬过滤。
...
首次进入后，打开“设置”填写个人档案。每天在“今日计划”填写当天状态后生成计划。没有 DeepSeek Key 时会自动使用本地规则版计划。
...
- 档案缺失时给出补全提示。
- 热量缺口不会过激。
- 爬坡计划会根据当天可运动时间、疲劳、睡眠、饥饿和身体状态调整。
